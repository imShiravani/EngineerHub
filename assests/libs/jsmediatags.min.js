    ...
    return function f(p, q, m) {
                ...
                m(f, [{
                    ...
                    value: function(e, d) {
                        for (var c, a, b = -1, g = -1, h = 0, k = 0; k < this._fileData.length; k++, h = k) {
                            ...
                            if (d < a - 1) break;
                            if (e <= c + 1 && d >= a - 1) { b = k; break }
                        }
                        if (-1 === b) return { startIx: -1, endIx: -1, insertIx: h };
                        for (k = b; k < this._fileData.length && !(a = this._fileData[k].offset, c = a + this._fileData[k].data.length, d >= a - 1 && (g = k), d <= c + 1); k++); - 1 === g && (g = b);
                        return { startIx: b, endIx: g }
                    }
                }, {
                    key: "hasDataRange",
                    ...
                    value: function(e) {
                        for (var d, c = 0; c < this._fileData.length; c++) {
                            ...
                            if (e >= a && e <= b) { d = this._fileData[c]; break }
                        }
        ...
        8: [function(f, p, q) {
            ...
            function l(a, b, d, c) {
                ...
                return { user_description: c.toString(), data: a.toString() }
            }
            var e = function() {
                function a(a, b) {
            ...
            var b = {
                ...
                COMM: function(a, b, c, d, g) {
                    ...
                    return { language: d, short_description: g.toString(), text: a.toString() }
                }
            };
            b.COM = b.COMM;
            ...
            b.UFID = function(a, b, c, g, e) {
                ...
                return { ownerIdentifier: g.toString(), identifier: a }
            };
        ...
        11: [function(f, p, q) {
            ...
            f = function() {
                ...
                m(e, [{
                        ...
                        value: function(d) {
                            var c = this;
                            if (this._isInitialized) setTimeout(d.onSuccess, 1);
                    ...
                    }, { key: "_init", value: function(d) { throw Error("Must implement init function"); } }, { key: "loadRange", value: function(d, c) { throw Error("Must implement loadRange function"); } }, {
                        key: "getSize",
                        value: function() {
                    ...
                    }, { key: "getSShortAt", value: function(d, c) { d = this.getShortAt(d, c); return 32767 < d ? d - 65536 : d } }, {
                        key: "getLongAt",
                        value: function(d, c) {
                    ...
                    }, { key: "getSLongAt", value: function(d, c) { d = this.getLongAt(d, c); return 2147483647 < d ? d - 4294967296 : d } }, {
                        key: "getInteger24At",
                        value: function(d, c) {
                            var a = this.getByteAt(d),
                                b = this.getByteAt(d + 1);
                    ...
                    }, { key: "getStringAt", value: function(d, c) { for (var a = [], b = d, e = 0; b < d + c; b++, e++) a[e] = String.fromCharCode(this.getByteAt(b)); return a.join("") } }, {
                        key: "getStringWithCharsetAt",
                        value: function(d, c, a) {
                    ...
                    { key: "getCharAt", value: function(d) { return String.fromCharCode(this.getByteAt(d)) } }, {
                        ...
                        this._mediaFileReader.init({
                            onSuccess: function() {
                                d._loadData(d._mediaFileReader, {
                                    onSuccess: function() {
                                        try { var c = d._parseData(d._mediaFileReader, d._tags) } catch (a) { if (e.onError) { e.onError({ type: "parseData", info: a.message }); return } }
                                        e.onSuccess(c)
                                    },
                                    onError: e.onError
                                })
        ...
        13: [function(f, p, q) {
            var m = function() {
                ...
                l = function() {
                    ...
                    m(e, [{ key: "toString", value: function() { return this._value } }]);
                    return e
                }();
            p.exports = {
                ...
                readNullTerminatedString: function(e, d) {
                    var c = [];
                    d = d || e.length;
                    for (var a = 0; a < d;) {
                        var b = e[a++];
        ...
        14: [function(f, p, q) {
            ...
            q = function(d) {
                    ...
                    value: function(a) {
                        ...
                        this._makeXHRRequest("GET", c, {
                            onSuccess: function(c) {
                                ...
                                if (d) {
                                    if (null == d.instanceLength) { b._fetchEntireFile(a); return }
                ...
                }, { key: "_setRequestHeader", value: function(a, b, d) { 0 > c._config.disallowedXhrHeaders.indexOf(b.toLowerCase()) && a.setRequestHeader(b, d) } }, {
                ...
                }], [{ key: "canReadFile", value: function(a) { return "string" === typeof a && /^[a-z]+:\/\//i.test(a) } }, {
                    key: "setConfig",
                    value: function(a) {
        ...
        15: [function(f, p, q) {
            ...
            var k = [],
                ...
                v = function() {
                    function a() { m(this, a) }
                    e(a, null, [{ key: "addFileReader", value: function(b) { k.push(b); return a } }, { key: "addTagReader", value: function(b) { r.push(b); return a } }, {
                            key: "removeTagReader",
                            value: function(b) {
                                b = r.indexOf(b);
                                0 <= b && r.splice(b, 1);
